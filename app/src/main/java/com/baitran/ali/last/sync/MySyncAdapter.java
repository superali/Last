...
import com.baitran.ali.last.ForecastFragment;
import com.baitran.ali.last.MainActivity;
import com.baitran.ali.last.R;
...
public class MySyncAdapter extends AbstractThreadedSyncAdapter{
    private final String LOG_TAG = MySyncAdapter.class.getSimpleName();
        ...
        if (displayNotifications) {
           ...
           if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                Uri weatherUri = WeatherContract.WeatherEntry
                        .buildWeatherLocationWithStringDate(
