package com.baitran.ali.last.service;
...
import com.baitran.ali.last.Utility;
...
/**
 * Created by ali on 14/12/15.
 */
public class FirstService extends IntentService {
    private final String LOG_TAG = FirstService.class.getSimpleName();
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String OPEN_WEATHER_MAP_API_KEY = "5ec0c25da74f6879776c44247f312897";
        String format = "json";
        String units = "metric";
        int numDays = 14;
        ...
        try {
            ...
            Log.e(LOG_TAG, "Errorrrrrrr in service ", e);
    ...
    abstract public class AlarmReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            Intent startServiceIntent = new Intent(context, FirstService.class);
            startServiceIntent.putExtra(FirstService.LOCATION_QUERY_EXTRA,
